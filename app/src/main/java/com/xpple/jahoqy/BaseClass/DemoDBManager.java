...
public class DemoDBManager {
     ...
     * @param contactList
     */
    synchronized public void saveContactList(List<HuanXinUser> contactList) {
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        if (db.isOpen()) {
            db.delete(UserDao.TABLE_NAME, null, null);
            for (HuanXinUser user : contactList) {
     ...
     * @return
     */
    synchronized public Map<String, HuanXinUser> getContactList() {
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        Map<String, HuanXinUser> users = new HashMap<String, HuanXinUser>();
        if (db.isOpen()) {
     ...
     * @param user
     */
    synchronized public void saveContact(HuanXinUser user){
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(UserDao.COLUMN_NAME_ID, user.getUsername());
        if(user.getNick() != null)
