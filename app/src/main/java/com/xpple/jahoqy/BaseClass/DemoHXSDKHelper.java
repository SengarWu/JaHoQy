...
import com.xpple.jahoqy.bean.RobotUser;
import com.xpple.jahoqy.receiver.CallReceiver;
import com.xpple.jahoqy.ui.activity.ChatActivity;
import com.xpple.jahoqy.ui.mainFragment.IndexFragment;
import com.xpple.jahoqy.ui.activity.VideoCallActivity;
import com.xpple.jahoqy.ui.activity.VoiceCallActivity;
import com.xpple.jahoqy.util.CommonUtils;
import com.xpple.jahoqy.BaseClass.HXNotifier.HXNotificationInfoProvider;
...
public class DemoHXSDKHelper extends HXSDKHelper{
    ...
    protected void onConnectionConflict(){
        Intent intent = new Intent(appContext, IndexFragment.class);
     ...
     * @param contactList
     */
    public void setContactList(Map<String, HuanXinUser> contactList) {
     ...
     * 保存单个user 
     */
    public void saveContact(HuanXinUser user){
    ...
    /**
     * update HuanXinUser cach And db
     *
     * @param contactList
     */
    public void updateContactList(List<HuanXinUser> contactInfoList) {
         for (HuanXinUser u : contactInfoList) {
			contactList.put(u.getUsername(), u);
         }
         ArrayList<HuanXinUser> mList = new ArrayList<HuanXinUser>();
