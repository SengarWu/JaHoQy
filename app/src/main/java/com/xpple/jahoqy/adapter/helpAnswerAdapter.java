 ...
 */
public class helpAnswerAdapter extends BaseListAdapter<Question> {
    protected ImageLoader imageLoader = ImageLoader.getInstance();
    public helpAnswerAdapter(Context context, List<Question> items) {
        super(context, items);
    }
    ...
    public View bindView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.include_myhelpque, null);
        }
