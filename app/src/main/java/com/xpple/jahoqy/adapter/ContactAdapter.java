...
public class ContactAdapter extends ArrayAdapter<HuanXinUser>  implements SectionIndexer{
	...
	List<String> list;
	List<HuanXinUser> userList;
	List<HuanXinUser> copyUserList;
	...
	public ContactAdapter(Context context, int resource, List<HuanXinUser> objects) {
		super(context, resource, objects);
		this.res = resource;
		this.userList = objects;
		copyUserList = new ArrayList<HuanXinUser>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		HuanXinUser user = getItem(position);
		if(user == null)
		...
		if(username.equals(Constant.GROUP_USERNAME)){
			//群聊item
		    holder.nameTextview.setText("帮派");
	...
	@Override
	public HuanXinUser getItem(int position) {
	...
	private class  MyFilter extends Filter{
        List<HuanXinUser> mOriginalList = null;
		
		public MyFilter(List<HuanXinUser> myList) {
		...
		protected synchronized FilterResults performFiltering(CharSequence prefix) {
			...
			if(mOriginalList==null){
			    mOriginalList = new ArrayList<HuanXinUser>();
			}
			...
			if(prefix==null || prefix.length()==0){
				...
				final ArrayList<HuanXinUser> newValues = new ArrayList<HuanXinUser>();
				for(int i=0;i<count;i++){
					final HuanXinUser user = mOriginalList.get(i);
					String username = user.getUsername();
		...
		protected synchronized void publishResults(CharSequence constraint,
			...
			userList.clear();
			userList.addAll((List<HuanXinUser>)results.values);
