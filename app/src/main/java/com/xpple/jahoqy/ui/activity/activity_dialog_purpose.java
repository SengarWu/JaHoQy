...
/**
 * Created by caolin on 2015/11/2.
 */
public class activity_dialog_purpose extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dialog_purpose);
                            ...
                            query.findObjects(mContext, new FindListener<Gangs>() {
                                ...
                                public void onSuccess(List<Gangs> list) {
                                    if (list != null && list.size() > 0) {
                                        ...
                                        gangs.setGangsPurpose(tv_ganggao.getText().toString());
