...
import com.xpple.jahoqy.adapter.endhelpAdapter;
...
public class endmySeek extends BaseActivity {
    private ZrcListView listView;
    private Handler handler;//用于接收子线程的信息以刷新主线程
    int curPage = 0;
    private endhelpAdapter adapter;
    private ArrayList<OfferHelp> items = new ArrayList<>();
    private String obid;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_endmy_seek);
        initView();
    }
    ...
    private void initView() {
        ...
        initTopBarForLeft("完结事务", R.mipmap.action_comment, R.mipmap.ic_launcher);
        listView=(ZrcListView)findViewById(R.id.endhelplist);
        handler = new Handler();
        ...
        adapter = new endhelpAdapter(this, items);
