...
import com.xpple.jahoqy.adapter.ChatAllHistoryAdapter;
import com.xpple.jahoqy.adapter.NewFriendsMsgAdapter;
...
import com.xpple.jahoqy.ui.activity.ContactlistActivity;
...
//    private ImageButton notifyButton;
    ...
    private RelativeLayout contversation_search_bar;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        contversation_search_bar=(RelativeLayout)getView().findViewById(R.id.contversation_search_bar);
        chatButton=(RadioButton)getView().findViewById(R.id.chatButton);
        notifyButton=(RadioButton)getView().findViewById(R.id.notifyButton);
        contactList=(ImageButton)getView().findViewById(R.id.contactList);
        group=(RadioGroup)getView().findViewById(R.id.setType);


        group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                if(radioGroup.getCheckedRadioButtonId()==R.id.chatButton){
                    listView.setVisibility(View.VISIBLE);
                    contversation_search_bar.setVisibility(View.VISIBLE);
                    listView1.setVisibility(View.GONE);
                }else{
                    listView1.setVisibility(View.VISIBLE);
                    listView.setVisibility(View.GONE);
                    contversation_search_bar.setVisibility(View.GONE);
                    //消息与通知
                    InviteMessgeDao dao = new InviteMessgeDao(getActivity());
                    List<InviteMessage> msgs = dao.getMessagesList();
                    //设置adapter
                    NewFriendsMsgAdapter adapter1 = new NewFriendsMsgAdapter(getActivity(), 1, msgs);
                    listView1 = (ListView) getView().findViewById(R.id.list1);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (username.equals(CustomApplication.getInstance().getUserName()))
